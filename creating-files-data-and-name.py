...
full_path_to_images = r'C:\Users\Admin\PycharmProjects\Make_model_with_YOLO\Labelled-Data\videos'
...
# Initialize classes.txt file
# with open(os.path.join(full_path_to_images, 'classes.txt'), 'w') as file:
#     pass
